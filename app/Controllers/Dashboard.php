...
class Dashboard extends Security_Controller {
    ...
    public function index() {
        ...
        if ($this->login_user->user_type === "staff" && $this->show_staff_on_staff) {
         ...
         else if($this->login_user->user_type === "sponsor" && $this->show_staff_on_staff) {
            $client_default_dashboard = get_setting("sponsor_default_dashboard");
            if ($client_default_dashboard) {
                ...
                echo $this->template->rander("dashboards/sponsor_dashboard", $view_data);
            }
        }
        else {
    ...
    function sponsor_default_dashboard() {
        $this->access_only_admin_or_settings_admin();
        $this->show_staff_on_staff = false;
        ...
        if ($client_default_dashboard) {
            ...
            $dashboard_view = $this->template->view("dashboards/sponsor_dashboard", $view_data);
        }

        $view_data["dashboard_view"] = $dashboard_view;

        return $this->template->rander("settings/sponsor_default_dashboard/index", $view_data);
    }
