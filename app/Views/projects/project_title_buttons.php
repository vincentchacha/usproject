...
?>
    <div class="dropdown btn-group">
        ...
        <ul class="dropdown-menu" role="menu">
            ...
            <?php } ?>
            <?php if ($project_info->status != "hold") { ?>
                <li role="presentation"><?php echo ajax_anchor(get_uri("projects/change_status/$project_info->id/open"), "<i data-feather='grid' class='icon-16'></i> " . "Approve Project to sponsors", array("class" => "dropdown-item", "title" => "Approve Project to sponsors", "data-reload-on-success" => "1")); ?> </li>
                <?php
            }
