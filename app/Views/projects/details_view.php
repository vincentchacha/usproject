                ...
                <div class="page-title no-bg clearfix mb5 no-border">
                    <div>
                        <h1 class="pl0">
                            ...
                            <?php } 
                            else if ($project_info->status == "pending") { ?>
                                <span title="<?php echo "Pending Approval"; ?>"><i data-feather="check-circle" class='icon'></i></span>
                            <?php }
                            
                            else if ($project_info->status == "hold") { ?>
                            ...
                            <?php echo $project_info->title; ?> -  <?php echo $project_info->location; ?>
